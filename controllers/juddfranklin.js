...
var section = require('fundation').model.section;

module.exports = function (app) {

  app.route('/juddfranklin').get(function (req, res, next) {
    res.render('juddfranklin.swig', {
      sections: [
    {
      id: 'interfaces',
      title: 'Interfaces',
      ...
      card: {
        ...
        exampleWork: '<p><a href="http://mammothmountain.com">mammothmountain.com</a> was built in sitefinity, using C# templating. Elements were modular, and reused across many pages and sites under the Mammoth banner.</p>'
      }
    },
  ],
    });
